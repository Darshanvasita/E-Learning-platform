    ...
    <section className="home">
      ...
      <div className="footer">
        <div className="parentFooter">
          <div className="box11">
          <div className="logo">
            <h1 onClick={() => navigate("/")}>EduQuest</h1>
            <p style={{color:"wheat"}}>Unlock Knowledge, <br /> Conquer Every Challenge</p>
          </div>
            <p>+079-********</p>
          </div>
          <div className="box12">
        ...
        <div className="childFooter">
          <h4>Copyright © 2022 EduQuest (Unlock Knowledge,
            Conquer Every Challenge) All rights reserved</h4>
